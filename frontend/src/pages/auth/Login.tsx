...
import { login, verifyToken, getRegistrationStatus, generateCaptcha, verifyCaptcha, sendVerificationCode } from '@/api/auth'
...
export function Login() {
  ...
  // 登录滑动验证码开关：默认关闭，避免加载第三方极验并触发外联请求
